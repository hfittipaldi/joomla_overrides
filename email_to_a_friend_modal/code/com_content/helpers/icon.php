...
abstract class JHtmlIcon
{
    ...
    public static function create($category, $params, $attribs = array(), $legacy = false)
    {
        ...
        if ($params->get('show_icons'))
        {
            ...
            {
                $text = '<span class="glyphicon glyphicon-plus"></span>&#160;' . JText::_('JNEW');
            }
        }
        else
        {
    ...
    public static function email($article, $params, $attribs = array(), $legacy = false)
    {
        ...
        $attribs['data-target'] = '#basicModal-' . MailToHelper::addLink($link);
        $attribs['role']        = 'button';
    ...
    public static function edit($article, $params, $attribs = array(), $legacy = false)
    {
            ...
            && $article->checked_out != $user->get('id'))
        {
            ...
            {
                $text = '<span class="hasTooltip glyphicon glyphicon-lock" title="' . JHtml::tooltipText($tooltip . '', 0) . '"></span>&#160;' . JText::_('JLIB_HTML_CHECKED_OUT');
            }
        ...
        else
        {
            ...
            $text = '<span class="hasTooltip glyphicon glyphicon-' . $icon . ' tip" title="' . JHtml::tooltipText(JText::_('COM_CONTENT_EDIT_ITEM'), $overlib, 0, 0)
                . '"></span>&#160;'
